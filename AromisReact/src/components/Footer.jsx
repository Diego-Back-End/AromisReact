// Este componente muestra el pie de página de la página web
function Footer() {
  return (
    ...
    <footer className="bg-dark text-white pt-5 pb-3">
      <div className="container text-center text-md-start">
        <div className="row">
          ...
          {/* Primera columna: información de la tienda */}
          <div className="col-md-4 mb-4">
            <h5 className="text-uppercase fw-bold mb-3">Aromis Perfumería</h5>
            <p>
              Descubre tu aroma único con nuestros perfumes exclusivos y disfruta
              de la mejor experiencia de compra online.
            </p>
          </div>
        ...
        {/* Texto del final con derechos reservados */}
        <div className="text-center pt-3">
          <p className="mb-0">
            &copy; 2025 Aromis Perfumería. Todos los derechos reservados.
          </p>
        </div>
      </div>
    </footer>
